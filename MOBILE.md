...
Web push is opt-in and requires a configured VAPID public key plus a delivery worker/provider. Subscription endpoints are persisted with audit events; email, SMS, and WhatsApp remain disabled.